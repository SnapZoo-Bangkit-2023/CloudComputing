...
@app.route('/')
def base_url():
    hewan = ['gajah', 'singa', 'badak', 'harimau', 'jerapah', 'monyet', 'penguin', 'rusa', 'ular', 'zebra']  # Daftar hewan yang dapat diterima

    endpoints = {
        'predict': 'https://snapzoo-capstone.et.r.appspot.com/predict',
        'deskripsi': 'https://snapzoo-capstone.et.r.appspot.com/deskripsi',
        'deskripsi_detail': 'https://snapzoo-capstone.et.r.appspot.com/deskripsi/<string:animal>'
    }

    output = {
        'base_url': 'https://snapzoo-capstone.et.r.appspot.com',
        'endpoints': endpoints,
        'supported_animals': hewan
    }
...
def get_objects():
    arr_objek = list(objek.values())
    return jsonify(arr_objek)
